...
import { Area, ManagementCreateAreaGQL, ManagementUpdateAreaGQL } from 'src/generated/graphql';
...
@Component({
    ...
    imports: [MatDialogModule, MatLabel, FormsModule, ReactiveFormsModule, MatFormField]
})
