...
import { IStarRatingChartDistribution, StarRatingChartComponent } from 'src/app/common/star-rating-chart/star-rating-chart.component';
...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, MatExpansionModule, StarRatingComponent, StarRatingChartComponent],
