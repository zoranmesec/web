...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, GradeComponent, InfoPropertyComponent, MatExpansionModule, MatIconModule, StarRatingComponent]
})
export class RouteInfoComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        this.hideGrade = this.route.properties.find((property) => property.propertyType.id === 'extGrade') !== null;
