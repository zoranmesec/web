import { ChangeDetectionStrategy, Component, ElementRef, input, OnChanges, OnDestroy, output, ViewChild } from '@angular/core';
...
export class SearchComponent implements OnDestroy, OnChanges {
    ...
    ngOnChanges(): void {
        ...
        if (this.forCrag() !== undefined && this.forCrag() !== null && this.searchType() !== SearchType.Route) {
        ...
        this.subscription = this.searchForm.controls.searchControl.valueChanges
            ...
            .subscribe({
                next: (result) => {
                    this.searchResults = result.data.searchByInput as SearchResults;
