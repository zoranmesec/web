  ...
  constructor(private readonly fb: FormBuilder) {
    ...
    this.columnForm = this.fb.group({
      name: new FormControl(
        savedColumns ? savedColumns.includes('name') : true
      ),
      length: new FormControl(
        savedColumns ? savedColumns.includes('length') : true
      ),
      difficulty: new FormControl(
        savedColumns ? savedColumns.includes('difficulty') : true
      ),
      nrTicks: new FormControl(
        savedColumns ? savedColumns.includes('nrTicks') : true
      ),
      nrTries: new FormControl(
        savedColumns ? savedColumns.includes('nrTries') : true
      ),
      nrClimbers: new FormControl(
        savedColumns ? savedColumns.includes('nrClimbers') : true
      ),
      starRating: new FormControl(
        savedColumns ? savedColumns.includes('starRating') : true
      ),
      multipitch: new FormControl(
        savedColumns ? savedColumns.includes('multipitch') : true
      ),
      comments: new FormControl(
        savedColumns ? savedColumns.includes('comments') : true
      ),
      myAscents: new FormControl(
        savedColumns ? savedColumns.includes('myAscents') : true
      ),
    });
