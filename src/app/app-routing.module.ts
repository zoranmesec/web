...
export const routes: Routes = [
    { path: '', redirectTo: '/home', pathMatch: 'full' },
    {
        path: 'home',
        title: 'Plezanje.net',
        loadComponent: async () => import('./pages/home/home.component').then((mod) => mod.HomeComponent)
    },
    {
        path: 'registracija',
    ...
    },
    {
        ...
        loadChildren: () => import('./peaks/peaks.module').then((m) => m.PeaksModule)
    },
    {
        path: 'alpinizem/slapovi',
        loadChildren: () => import('./ice-falls/ice-falls.module').then((m) => m.IceFallsModule)
    },
    {
        path: 'o-plezanje-net',
